...
namespace ThreadPoolDemo
{
    class Program
    {
        ...
        {
            //making a for loop to tjek how much the time would change
            //the thread pool took 3000 and the thread took 250000
            for (int i = 0; i < 100000; i++)
            {
                //making a second loop the see how much the time would change
                //the thread pool 3000 and the thread took 11000000
